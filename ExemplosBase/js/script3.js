...
for ( i=1; i <= qtd_bolinhas;i++){
	let bola = new Bolinha(cores[Math.round(Math.random()*(cores.length-1))], Math.round(Math.random() * 500), Math.round(Math.random() * 500), Math.round((Math.random()*50)+10));
